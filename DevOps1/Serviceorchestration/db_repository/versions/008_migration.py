...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['VNF__catalogue'].columns['count'].drop()
    post_meta.tables['VNF__catalogue'].columns['image_id'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['VNF__catalogue'].columns['count'].create()
    post_meta.tables['VNF__catalogue'].columns['image_id'].drop()
